    ...
    function linearGradientImage(){
      ...
      switch (start) {
        case 'top':
          ...
          from = { x: canvas.width / 2, y: 0 };
          to = { x: canvas.width / 2, y: canvas.height };
          break;
        case 'bottom':
          canvas = new Canvas(1, size);
          from = { x: canvas.width / 2, y: canvas.height };
          to = { x: canvas.width / 2, y: 0 };
          break;
        case 'left':
        ...
        case 'right':
          canvas = new Canvas(size, 1);
          from = { x: canvas.width, y: canvas.height };
          to = { x: 0, y: 0 };
          break;
        default:
