...
var RE_GRADIENT_VAL = /(\(\s*)(?:(-?(\d*\.)?\d+)deg|((to )?(top|bottom|left|right)( (top|bottom|left|right))?))/g
var RE_GRADIENT_TYPE = /((repeating-)?(linear|radial)-gradient\()/g
var RE_TRANSFORM = /\b(transform)\b/g
var RE_FILL_KEYWORD = /\s*\b(fill)\b\s*/g
